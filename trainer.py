...
def gradient_descent(X_train, Y_train, num_iters = 500, alpha = 0.1):
    ...
    for iters in range(1, num_iters+1):
        ...
        if (iters)%10 == 0:
            ...
            print(("#"*(iters//10)) + ("."*((num_iters-iters)//10)), end='\r')
    return W1, b1, W2, b2
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        print("\n","-"*20)
        print("\nRunning Epoch", epoch + 1, "of", num_epochs)
        print(("."*((num_iters)//10)), end='\r')
        W1, b1, W2, b2 = gradient_descent(X_train, Y_train, num_iters, learning_rate)
        dev_predictions = make_predictions(X_dev, W1, b1, W2, b2)
        current_accuracy = get_accuracy(dev_predictions, Y_dev)
